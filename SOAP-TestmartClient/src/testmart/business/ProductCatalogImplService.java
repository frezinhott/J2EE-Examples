 ...
 * 
 */
@WebServiceClient(name = "ProductCatalogImplService", targetNamespace = "http://business.testmart/", wsdlLocation = "http://desktop-dbq9nnp:8080/SOAP-Testmart/ProductCatalogImplService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTCATALOGIMPLSERVICE_QNAME = new QName("http://business.testmart/", "ProductCatalogImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://desktop-dbq9nnp:8080/SOAP-Testmart/ProductCatalogImplService?wsdl");
    ...
    public ProductCatalog getProductCatalogImplPort() {
        return super.getPort(new QName("http://business.testmart/", "ProductCatalogImplPort"), ProductCatalog.class);
    }
    ...
    public ProductCatalog getProductCatalogImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://business.testmart/", "ProductCatalogImplPort"), ProductCatalog.class, features);
    }
