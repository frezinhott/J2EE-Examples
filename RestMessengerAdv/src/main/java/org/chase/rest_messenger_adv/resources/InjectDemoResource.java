...
public class InjectDemoResource {
	...
	/**
	 * http://localhost:8080/RestMessengerAdv/api/injectdemo/annotations
	 * 
	 * @MatrixParam are separated by a ";"
	 * http://localhost:8080/RestMessengerAdv/api/messages;param=variable
	 * 
	...
	/**
	 * http://localhost:8080/RestMessengerAdv/api/context
	 * 
