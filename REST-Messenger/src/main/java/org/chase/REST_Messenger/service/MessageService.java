...
import org.chase.REST_Messenger.exception.DataNotFoundException;
...
public class MessageService {
	...
	public MessageService(){
		Comment comment1 = new Comment(1L, "Trevor's First Message", "Trevor Chase");
		Comment comment2 = new Comment(1L, "Barbara's First Message", "Barbara Chase");
