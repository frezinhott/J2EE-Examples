...
import org.chase.REST_Messenger.resources.beans.MessageFilterBean;
import org.chase.REST_Messenger.service.MessageService;
...
public class MessageResource {
	 ...
	 * http://localhost:8080/REST-Messenger/webapi/messages?year=variable
	 * 
	 * Get #=size messages starting at id=start
	 * http://localhost:8080/REST-Messenger/webapi/messages?start=variable&size=variable
	 * 
	...
	public Response getMessages(@BeanParam MessageFilterBean filterBean,
		...
		for(Message message : messages){
			...
			Map<Long, Comment> messageComments = new HashMap<>();
			long i=0;
	...
	/**
	 * http://localhost:8080/REST-Messenger/webapi/messages/{messageId} 
	 * 
	...
	/**
	 * This method constructs the URI link to the message comments resource
	 * http://localhost:8080/messenger/webapi/messages/{messageId}/comments/{commentId}
	 * 
	 * @param uriInfo
	 * @param message
	 * @return
	 ...
	 * http://localhost:8080/messenger/webapi/profiles/{profileName}
	 * 
	 * @param uriInfo
	 * @param message
	 * @return
	...
	/**
	 * http://localhost:8080/REST-Messenger/webapi/messages/{messageId}/comments
	 * 
	...
	/**
	 * http://localhost:8080/REST-Messenger/webapi/messages/test
	 * 
	...
	/**
	 * http://localhost:8080/REST-Messenger/webapi/messages/test/{regExpression: * }
